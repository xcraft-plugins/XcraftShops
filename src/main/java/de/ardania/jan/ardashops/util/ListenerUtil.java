...
public class ListenerUtil {
    ...
    public static void basicInventoryClickEventChecks(InventoryClickEvent event) {
        ...
        if (event.getRawSlot() == -999) return; //Überprüft ob der Spieler auf den Bereich neben den Inventorys klickt.
        ...
        if (event.isShiftClick())
            event.setCancelled(true); //Überprüft ob der Spieler ein Item mittels Shift Click bewegen wollte.
    }
}
