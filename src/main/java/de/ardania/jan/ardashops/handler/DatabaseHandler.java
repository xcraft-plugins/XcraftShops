...
public class DatabaseHandler {
    ...
    private static List<Item> getItemList(ResultSet resultSet) throws SQLException {
        Item item = null;
    ...
    private static ItemStack getItemStackFromSQL(ResultSet resultSet) throws SQLException {
    ...
    public static Shop getShopFromUUID(UUID ownerUUID) throws SQLException {
    ...
    public static void insertItem (Item item, UUID ownerUUID) throws SQLException {
